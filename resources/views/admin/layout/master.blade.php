                    ...
                    <div class="tab-pane active" id="hr_menu">
                        <nav class="sidebar-nav">
                            <ul class="main-menu metismenu active list-unstyled">
                                ...
                                <li class="{{ in_array($currentRoute, ['admin.employee', 'admin.attendance']) ? 'active mm-active' : '' }}">
                                ...
                                <li class="{{ in_array($currentRoute, ['admin.role', 'admin.department', 'admin.company', 'admin.designation'   ]) ? 'active mm-active' : '' }}">
                                    ...
                                    <ul class="list-unstyled {{ in_array($currentRoute, ['admin.role', 'admin.department', 'admin.company', 'admin.designation']) ? 'mm-show' : '' }}">
                                        ...
                                        <li class="{{ $currentRoute == 'admin.designation' ? 'active' : '' }}"><a href="{{ route('admin.designation') }}">Designation</a></li>
